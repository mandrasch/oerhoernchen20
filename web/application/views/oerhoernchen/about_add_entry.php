<?php defined('BASEPATH') or exit('No direct script access allowed');?>
    ...
    <div class="container">
        <div class="row">
            ...
            <p> Disclaimer: Es handelt sich bei dieser Webseite um einen Prototypen.</p>
            <h2>Sie möchten einen bereits hochgeladenen Inhalt zum Suchindex hinzufügen?</h2>
            <p>Der einfachste Weg wäre, hier ein Formular zur Erfassung anzubieten. Dieses habe ich bereits prototypisch implementiert: <a href="<?php echo site_url("lesezeichen/hinzufuegen");?>">Eintrag hinzufügen</a>. Als Einzelperson kann ich aber die Verantwortung für die Redaktion sowie die Haftungsrisiken für mögliche Urheberrechtsfragen nicht tragen, sodass diese Funktion nicht öffentlich aktiviert ist. Daher sind Bundesländerinitiativen sowie Hochschulangebote so immens wichtig für den offenen Austausch von Lehrmaterial: Es geht um Verantwortung und langfristiges Bereitstellen der Inhalte.
              <p>Je nach Bundeslandzugehörigkeit haben Sie  bereits einige Optionen auf Bundeslandebene - in Zukunft sollen durch OER-Länderinitiativen weitere Möglichkeiten hinzukommen (ggf. existiert an ihrer Hochschule bereits ein OER-Angebot/Repository, diese sind jedoch noch nicht sehr verbreitet). Das große Ziel ist hierbei, dass in allen 16 Bundesländern Hochschulmitarbeiter*innen offenes Lehrmaterial in vielfältigen Formaten veröffentlichen können, welches dann über gute Suchinterfaces einfach und schnell auffindbar ist (dezentrale Vernetzung). Derzeitige Optionen:
            <ul>
          ...
          <p>  <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/SHB7Tpc8UAc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
