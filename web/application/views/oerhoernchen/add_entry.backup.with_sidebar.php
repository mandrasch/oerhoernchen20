                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <b>Tools / Plattformen / Dateiformate</b>
                                                <?php $i = 0;?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                          <?php foreach ($higher_education_subjects as $item): ?>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="<?php echo $item->value; ?>" name="school_subjects" id="higherEducationSubjectsCheck<?php echo $i; ?>">
